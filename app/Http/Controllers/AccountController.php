...
use App\Services\SampleInvoiceDataGeneratorService;
...
class AccountController extends BaseController
{
    ...
    private function showInvoiceDesign($section)
    {
        ...
        if ($invoice = Invoice::scope()->invoices()->orderBy('id')->first()) {
            ...
            $client = SampleInvoiceDataGeneratorService::getSampleClient();
            $invoice = SampleInvoiceDataGeneratorService::getSampleInvoice();
            $contact = SampleInvoiceDataGeneratorService::getSampleContact();
            $invoiceItem = SampleInvoiceDataGeneratorService::getSampleInvoiceItem();
